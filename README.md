...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> Nitish Kumar </p>
    <p><strong>Email ID:</strong> nitishkumarg1salesforce@gmail.com </p>
    <p><strong>College Name:</strong> G L Bajaj College of Technology and Management </p>
    <p><strong>Branch/Specialization :</strong> MCA </p>
    <p><strong>College ID:</strong> 24550cn006@glbctm.ac.in </p>
</div>
...
<p><strong>Trainer Name:</strong> Sriram Yarrabothula</p>
<p><strong>Trainer Email ID:</strong> yarrabothulasriram@gmail.com</p>
<p><strong>Trainer Designation:</strong> Salesforce Developer - RAYON TECHNOLOGY SOLUTIONS PRIVATE LIMITED</p>
...
During this course, I learned the fundamentals of Salesforce development and application design. I gained hands-on experience with Apex, Lightning Web Components (LWC), SOQL, and Salesforce configuration tools, while strengthening my skills in problem-solving, teamwork, documentation, and building real-world business solutions.

<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Project 1:</a></strong> Employee Management System</p>

</div>

<!-- Project 1 -->
<h3 id="project1">Project 1: Employee Management System</h3>
<p>
  This project involved designing and developing an Employee Management System using the core concepts covered in the course. It focused on understanding business requirements, managing employee data, handling attendance and payroll processes, and building scalable solutions using Apex and Lightning Web Components with clean and structured development practices.
</p>
<p>
  <a href="https://github.com/sure-trust/NITISH-KUMAR-g1-salesforce/blob/eea533f7667a439643413a2a46091d3edd381315/Course%20report/SURE%20Trust%20project%20document11.pdf" target="_blank"><strong>→ View Full Project Report</strong></a>
</p>
...
LST and SST sessions helped me strengthen my understanding of Salesforce concepts through guided learning and self-practice. LST sessions provided clear explanations and practical insights, while SST sessions allowed me to apply those concepts independently, improving my problem-solving skills, confidence, and ability to build real-world solutions.
---
...
During my internship period, I participated in community-oriented activities that focused on collaboration, knowledge sharing, and peer support. I contributed by helping teammates with technical challenges, sharing learnings, and actively engaging in group discussions. These experiences improved my communication skills and reinforced the importance of teamwork and continuous learning.
